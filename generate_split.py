...
split_index = int(len(file_names) * train_frac)
file_names_train = file_names[:split_index]
...
if split_test:
    ...
    Your code below.
    '''
    gts_train = {f: gts[f] for f in file_names_train}
    gts_test  = {f: gts[f] for f in file_names_test}
